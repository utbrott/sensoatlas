...
import {
  ...
  Provider,
  useStore
} from '@store/piezo-cable'
import { Config } from '@atoms/config'
import {
  configFields,
  taskFields
} from '@data/laboratories/piezoelectricity/cable'
...
import { PageHeader, Article } from '@data/laboratories/piezoelectricity/cable'
